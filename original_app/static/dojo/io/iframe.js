...
if (!dojo._hasResource["dojo.io.iframe"]) {
    ...
    dojo.io.iframe = {
        ...
        doc: function (_a) {
            var _b =
                _a.contentDocument ||
                (_a.name && _a.document && dojo.doc.getElementsByTagName("iframe")[_a.name].contentWindow && dojo.doc.getElementsByTagName("iframe")[_a.name].contentWindow.document) ||
                (_a.name && dojo.doc.frames[_a.name] && dojo.doc.frames[_a.name].document) ||
                null;
            return _b;
        },
        send: function (_c) {
