...
if (!dojo._hasResource["dojox.layout.GridContainer"]) {
    ...
    dojo.declare("dojox.layout.GridContainer", [dijit._Widget, dijit._Templated, dijit._Container, dijit._Contained], {
        ...
        _createGrid: function () {
            ...
            if (this.hasResizableColumns) {
                ...
                for (var j = 0; j < _17.length; j++) {
                    var dz = _17[j];
                    var _19 = this;
                    this.handleDndStart.push(
                        dojo.connect(dz, "onDndStart", dz, function (_1a) {
                            if (_1a == this) {
                                _19.handleDndInsertNodes = [];
                                for (i = 0; i < _19.grid.length; i++) {
                                    _19.handleDndInsertNodes.push(
                                        dojo.connect(_19.grid[i], "insertNodes", _19, function () {
                                            _19._disconnectDnd();
                                        })
                                    );
                                }
        ...
        _createZone: function (_1b) {
            var dz = new dojox.layout.dnd.PlottedDnd(_1b.id, {
                    ...
                    var _42 = dojo.connect(dz, "onDndStart", dz, function (_43) {
                        if (_43 == this) {
                            ...
                            for (var o = 0; o < _41.grid.length; o++) {
                                _41.handleDndInsertNodes.push(
                                    dojo.connect(_41.grid[o], "insertNodes", _41, function () {
                                        _41._disconnectDnd();
                                    })
                                );
                            }
