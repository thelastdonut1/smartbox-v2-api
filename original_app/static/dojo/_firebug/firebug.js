        ...
        if (!dojo.isFF && (!dojo.isChrome || dojo.isChrome < 3) && (!dojo.isSafari || dojo.isSafari < 4) && !_8 && !window.firebug && typeof console != "undefined" && !console.firebug && !dojo.config.useCustomLogger && !dojo.isAIR) {
            ...
            function _3f() {
                ...
                _e.innerHTML =
                    ...
                    _44("Clear", "Remove All Console Logs", "clear", "") +
                    _44("ReCSS", "Refresh CSS without reloading page", "recss", "") +
                    _44("Console", "Show Console Logs", "openConsole", "gap") +
                    _44("DOM", "Show DOM Inspector", "openDomInspector", "") +
                    _44("Object", "Show Object Inspector", "openObjectInspector", "") +
                    (dojo.config.popup ? "" : _44("Close", "Close the console", "close", "gap")) +
                    "\t</ul>" +
                    "</div>" +
